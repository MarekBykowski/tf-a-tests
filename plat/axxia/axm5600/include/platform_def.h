 ...
 ******************************************************************************/
#define GPTIMER1_BASE			ULL(0x8080220020)
/*******************************************************************************
 * Shared-Peripheral-Interrupt (SPI) ID. Note this is in contrast to
 * the SPI offset that Linux is taking the notion of. As per porting-guide.rst:
 ...
 ******************************************************************************/
#define GPTIMER1_IRQ			62
#define GPTIMER1_FREQ			125000000
...
#define PL011_UART_CLK_IN_HZ            250000000

/* GIC-500 */
#define GICC_BASE			ULL(0x8001000000)
#define GICD_BASE			ULL(0x8010000000)
#define GICR_BASE			ULL(0x8010200000)
